...
/**
 * AOP aspect for automatic monitoring of service methods.
 * Provides automatic timing and counting of method executions.
 */
@Aspect
@Component
public class MonitoringAspect {
    ...
    public Object monitorDomainServiceMethods(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        Counter errorCounter = Counter.builder(metricName + ".errors")
        ...
        try {
            ...
            logger.debug("Domain service method executed successfully - Class: {}, Method: {}", 
                    className, methodName);
            return result;
        } catch (Exception e) {
            errorCounter.increment();
            logger.error("Domain service method failed - Class: {}, Method: {}, Error: {}", 
    ...
    public Object monitorInfrastructureServiceMethods(ProceedingJoinPoint joinPoint) throws Throwable {
        String methodName = joinPoint.getSignature().getName();
        String className = joinPoint.getTarget().getClass().getSimpleName();
        ...
        try {
            Object result = joinPoint.proceed();
            successCounter.increment();
            logger.debug("Infrastructure service method executed successfully - Class: {}, Method: {}", 
                    className, methodName);
            return result;
        } catch (Exception e) {
            errorCounter.increment();
            logger.error("Infrastructure service method failed - Class: {}, Method: {}, Error: {}", 
                    className, methodName, e.getMessage());
            throw e;
        } finally {
            sample.stop(Timer.builder(metricName + ".duration")
    ...
    public Object monitorRepositoryMethods(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            Object result = joinPoint.proceed();
            successCounter.increment();
            logger.debug("Repository method executed successfully - Class: {}, Method: {}", 
                    className, methodName);
            return result;
        } catch (Exception e) {
            errorCounter.increment();
            logger.error("Repository method failed - Class: {}, Method: {}, Error: {}", 
                    className, methodName, e.getMessage());
            throw e;
        } finally {
            sample.stop(Timer.builder(metricName + ".duration")
