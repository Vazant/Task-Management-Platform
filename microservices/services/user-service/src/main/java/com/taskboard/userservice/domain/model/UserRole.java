 ...
 * 
 * <p>User roles define the permissions and access levels that users have
 * within the system. This enum encapsulates all possible user roles and
 * provides business logic for role-based access control.</p>
 * 
 * <p>Role hierarchy (from highest to lowest privilege):</p>
 * <ul>
 *   <li>SUPER_ADMIN - Full system access and administration</li>
 *   <li>ADMIN - System administration and user management</li>
 *   <li>MANAGER - Project and team management</li>
 *   <li>USER - Standard user with basic permissions</li>
 *   <li>GUEST - Limited access for external users</li>
 * </ul>
 * 
