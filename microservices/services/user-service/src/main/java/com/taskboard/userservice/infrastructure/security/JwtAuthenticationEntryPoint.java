 ...
 *
 * <p>This class handles cases where a user tries to access a protected resource without proper
 * authentication. It returns a standardized error response with appropriate HTTP status code and
 * error message.
 *
 * <p>Key features:
 *
...
public class JwtAuthenticationEntryPoint implements AuthenticationEntryPoint {
   ...
   *
   * <p>This method is called whenever an AuthenticationException is thrown because a user is trying
