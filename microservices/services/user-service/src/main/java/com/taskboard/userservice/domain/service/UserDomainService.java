 ...
 * 
 * <p>This service encapsulates complex business logic that doesn't naturally
 * fit within a single User entity. It coordinates between multiple entities
 * and enforces business rules that span across the domain.</p>
 * 
 * <p>The service is responsible for:</p>
 * <ul>
 *   <li>Complex user creation and validation</li>
 *   <li>User lifecycle management</li>
 *   <li>Business rule enforcement</li>
 *   <li>Cross-entity operations</li>
 * </ul>
 * 
...
public class UserDomainService {
     ...
     * 
     * <p>This method enforces business rules for user creation:</p>
     * <ul>
     ...
     */
    private void validateUserCreation(String username, String email, String passwordHash, 
