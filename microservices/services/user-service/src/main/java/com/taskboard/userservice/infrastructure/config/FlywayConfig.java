 ...
 * 
 * <p>This configuration class sets up Flyway for database schema management
 * and provides custom migration strategies for different environments.</p>
 * 
 * <p>Key features:</p>
 * <ul>
 *   <li>Automatic migration on application startup</li>
 *   <li>Environment-specific migration strategies</li>
 *   <li>Validation of applied migrations</li>
...
public class FlywayConfig {
     ...
     * 
     * <p>This strategy is used in development to ensure clean migrations
     * and proper handling of schema changes during development.</p>
     * 
     ...
     * 
     * <p>This strategy is used in testing to ensure clean database state
     * for each test run and proper migration handling.</p>
     * 
     ...
     * 
     * <p>This strategy is used in production to ensure safe migrations
     * without data loss and proper validation of schema changes.</p>
     * 
