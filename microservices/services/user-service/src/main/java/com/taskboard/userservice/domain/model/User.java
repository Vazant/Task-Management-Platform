 ...
 * 
 * <p>This is the core domain entity that encapsulates user business logic
 * and maintains data integrity. It follows Domain-Driven Design principles
 * and contains only business-related behavior.</p>
 * 
 * <p>The User entity is responsible for:</p>
 * <ul>
 *   <li>Maintaining user identity and profile information</li>
 *   <li>Managing user status and roles</li>
 *   <li>Validating business rules</li>
 *   <li>Providing domain-specific behavior</li>
 * </ul>
 * 
