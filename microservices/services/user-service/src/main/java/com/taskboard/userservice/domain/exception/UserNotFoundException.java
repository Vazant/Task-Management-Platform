 ...
 * 
 * <p>This exception is thrown when operations are attempted on a user
 * that does not exist in the system. It provides clear indication
 * that the requested user entity was not found and helps distinguish
 * between different types of user-related errors.</p>
 * 
 * <p>This exception should be thrown when:</p>
 * <ul>
 *   <li>Attempting to retrieve a user by ID that doesn't exist</li>
 *   <li>Attempting to update a non-existent user</li>
 *   <li>Attempting to delete a non-existent user</li>
 *   <li>Any operation that requires an existing user</li>
 * </ul>
 * 
