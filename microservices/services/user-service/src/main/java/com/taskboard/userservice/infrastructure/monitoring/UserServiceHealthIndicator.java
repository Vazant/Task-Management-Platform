...
/**
 * Custom health indicator for the User Service. Provides detailed health information about the
...
public class UserServiceHealthIndicator implements HealthIndicator {
  ...
  /**
   * Gets the service start time. This is a simplified implementation - in a real scenario, you
   * might want to track this more accurately.
   *
