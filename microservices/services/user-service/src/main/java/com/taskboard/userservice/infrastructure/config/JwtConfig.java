 ...
 *
 * <p>This configuration class sets up JWT-related beans and configuration for token generation,
 * validation, and management.
 *
 * <p>Key features:
 *
 * <ul>
 *   <li>JWT secret key configuration
 *   <li>Token expiration settings
 *   <li>Key generation and validation
 * </ul>
 *
...
public class JwtConfig {
   ...
   *
   * <p>This method converts the configured JWT secret string into a SecretKey object that can be
