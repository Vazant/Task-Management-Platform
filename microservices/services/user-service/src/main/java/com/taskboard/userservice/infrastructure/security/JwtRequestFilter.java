 ...
 *
 * <p>This filter intercepts HTTP requests and processes JWT tokens for authentication. It extracts
 * the token from the Authorization header, validates it, and sets up the security context for the
 * authenticated user.
 *
 * <p>Key features:
 *
 * <ul>
 *   <li>Token extraction from Authorization header
 *   <li>Token validation and user authentication
 *   <li>Security context setup
 *   <li>Request chain continuation
 * </ul>
 *
...
public class JwtRequestFilter extends OncePerRequestFilter {
   ...
   *   <li>Validates the token and extracts username
   *   <li>Loads user details and creates authentication
   *   <li>Sets the security context
   ...
   *
   * <p>This method can be overridden to skip the filter for certain requests, such as public
   * endpoints or health checks.
   *
   * @param request the HTTP request
