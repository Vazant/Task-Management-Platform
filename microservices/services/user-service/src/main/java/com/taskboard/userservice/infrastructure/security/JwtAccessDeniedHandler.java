 ...
 *
 * <p>This class handles cases where a user is authenticated but doesn't have sufficient permissions
 * to access a protected resource. It returns a standardized error response with appropriate HTTP
 * status code and error message.
 *
 * <p>Key features:
 *
 * <ul>
 *   <li>Standardized error response format
 *   <li>Proper HTTP status codes (403 Forbidden)
 *   <li>JSON error response
 *   <li>Timestamp and request information
 * </ul>
 *
...
public class JwtAccessDeniedHandler implements AccessDeniedHandler {
   ...
   *
   * <p>This method is called whenever an AccessDeniedException is thrown because a user doesn't
   * have sufficient permissions to access a protected resource.
   *
