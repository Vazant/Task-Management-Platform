 ...
 * 
 * <p>User status determines the current state of a user account and affects
 * their ability to perform actions within the system. This enum encapsulates
 * all possible user states and provides business logic for status transitions.</p>
 * 
 * <p>Possible statuses:</p>
 * <ul>
 *   <li>ACTIVE - User can log in and use the system</li>
 *   <li>INACTIVE - User account is temporarily disabled</li>
 *   <li>BLOCKED - User account is blocked due to policy violations</li>
 *   <li>PENDING - User account is awaiting activation</li>
 * </ul>
 * 
