 ...
 * tokens. It handles token creation, expiration, and claims extraction.
 *
 * <p>Key features:
 *
 * <ul>
 *   <li>Token generation with custom claims
 *   <li>Token validation and expiration checking
 *   <li>Username and claims extraction
 *   <li>Refresh token support
 * </ul>
 *
