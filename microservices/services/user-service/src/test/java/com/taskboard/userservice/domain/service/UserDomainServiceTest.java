 ...
 *
 * <p>These tests verify the business logic and behavior of the UserDomainService, including user
...
class UserDomainServiceTest {
  ...
  class UserCreationTests {
    ...
    void shouldCreateUserSuccessfullyWithValidParameters() {
      ...
      // When
      User result =
          userDomainService.createUser(username, email, passwordHash, firstName, lastName, role);
    ...
    void shouldCreateUserWithDefaultUserRoleWhenRoleIsNull() {
      ...
      User expectedUser =
          new User(username, email, passwordHash, firstName, lastName, UserRole.USER);
      ...
      // When
      User result =
          userDomainService.createUser(username, email, passwordHash, firstName, lastName, null);
      ...
      assertThatThrownBy(
              () ->
                  userDomainService.createUser(
                      username, email, passwordHash, firstName, lastName, UserRole.USER))
    ...
    void shouldThrowUserDomainExceptionWhenUsernameIsNull() {
      ...
      assertThatThrownBy(
              () ->
                  userDomainService.createUser(
                      null, "test@example.com", "hash", "John", "Doe", UserRole.USER))
    ...
    void shouldThrowUserDomainExceptionWhenEmailIsInvalid() {
      ...
      assertThatThrownBy(
              () ->
                  userDomainService.createUser(
                      "testuser", "invalid-email", "hash", "John", "Doe", UserRole.USER))
          .isInstanceOf(UserDomainException.class)
  ...
  class UserProfileUpdateTests {
    ...
    void shouldUpdateUserProfileSuccessfully() {
      ...
      User existingUser =
          createUserWithId(
              "testuser", "old@example.com", "hash", "John", "Doe", UserRole.USER, userId);
    ...
    void shouldThrowUserNotFoundExceptionWhenUserDoesNotExist() {
      ...
      // When & Then
      assertThatThrownBy(
              () -> userDomainService.updateUserProfile(userId, "Jane", "Smith", "new@example.com"))
      ...
      assertThatThrownBy(
              () ->
                  userDomainService.updateUserProfile(
                      userId, "Jane", "Smith", "existing@example.com"))
          .isInstanceOf(UserAlreadyExistsException.class)
  ...
  class UserStatusManagementTests {
    ...
    void shouldActivateUserSuccessfully() {
      ...
      User user =
          createUserWithId(
              "testuser", "test@example.com", "hash", "John", "Doe", UserRole.USER, userId);
      user.deactivate();
    ...
    void shouldBlockUserSuccessfullyWhenUserHasPermission() {
      ...
      User adminUser =
          createUserWithId(
              "admin", "admin@example.com", "hash", "Admin", "User", UserRole.ADMIN, 2L);
    ...
    void shouldThrowUserDomainExceptionWhenNonAdminTriesToBlockUser() {
      ...
      User regularUser =
          createUserWithId(
              "regular", "regular@example.com", "hash", "Regular", "User", UserRole.USER, 2L);
