...
class SecurityAuditServiceTest {
    ...
    void shouldRecordSuccessfulLoginAttempt() {
        ...
        // Then
        assertThat(meterRegistry.find("security.login.attempts.total").counter().count()).isEqualTo(1.0);
        assertThat(meterRegistry.find("security.login.success.total").counter().count()).isEqualTo(1.0);
        assertThat(meterRegistry.find("security.login.failures.total").counter().count()).isEqualTo(0.0);
    }
    ...
    void shouldRecordFailedLoginAttempt() {
        ...
        assertThat(meterRegistry.find("security.login.failures.total").counter().count()).isEqualTo(1.0);
    ...
    void shouldRecordPasswordChange() {
        ...
        // Then
        assertThat(meterRegistry.find("security.password.changes.total").counter().count()).isEqualTo(1.0);
    }
    ...
    void shouldRecordAccountLockout() {
        ...
        // Then
        assertThat(meterRegistry.find("security.account.lockouts.total").counter().count()).isEqualTo(1.0);
    }
    ...
    void shouldRecordSuspiciousActivity() {
        ...
        // Then
        assertThat(meterRegistry.find("security.suspicious.activity.total").counter().count()).isEqualTo(1.0);
    }
    ...
    void shouldRecordValidJwtToken() {
        ...
        assertThat(meterRegistry.find("security.suspicious.activity.total").counter().count()).isEqualTo(0.0);
    }
    ...
    void shouldTrackMultipleFailedAttemptsFromSameIp() {
        ...
        // Then
        assertThat(meterRegistry.find("security.login.failures.total").counter().count()).isEqualTo(3.0);
    ...
    void shouldAccumulateMultipleMetrics() {
        ...
        securityAuditService.recordPasswordChange(username, ipAddress);
        securityAuditService.recordSuspiciousActivity("TEST_ACTIVITY", username, ipAddress, "Test details");
