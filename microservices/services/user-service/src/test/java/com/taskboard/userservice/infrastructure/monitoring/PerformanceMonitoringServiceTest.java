...
class PerformanceMonitoringServiceTest {
    ...
    void shouldRecordUserCreationMetrics() {
        ...
        assertThat(meterRegistry.find("user.creation.duration").timer().totalTime(java.util.concurrent.TimeUnit.MILLISECONDS))
                .isEqualTo(150.0);
    }
    ...
    void shouldRecordUserAuthenticationMetrics() {
        ...
        // Then
        assertThat(meterRegistry.find("user.authentication.success.total").counter().count()).isEqualTo(1.0);
        assertThat(meterRegistry.find("user.authentication.duration").timer().totalTime(java.util.concurrent.TimeUnit.MILLISECONDS))
                .isEqualTo(100.0);
    }
    ...
    void shouldRecordFailedUserAuthenticationMetrics() {
        ...
        // Then
        assertThat(meterRegistry.find("user.authentication.failure.total").counter().count()).isEqualTo(1.0);
        assertThat(meterRegistry.find("user.authentication.success.total").counter().count()).isEqualTo(0.0);
    }
    ...
    void shouldRecordUserUpdateMetrics() {
        ...
        assertThat(meterRegistry.find("user.update.duration").timer().totalTime(java.util.concurrent.TimeUnit.MILLISECONDS))
                .isEqualTo(200.0);
    }
    ...
    void shouldRecordUserDeletionMetrics() {
        ...
        assertThat(meterRegistry.find("user.deletion.duration").timer().totalTime(java.util.concurrent.TimeUnit.MILLISECONDS))
                .isEqualTo(75.0);
    }
