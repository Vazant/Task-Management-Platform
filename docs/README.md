...
- [Load Testing](docs/load-testing.md) - Нагрузочное тестирование с Apache JMeter
- [E2E Testing](docs/e2e-testing.md) - End-to-End тестирование с Cypress
- [Integration Guide](docs/integration-guide.md) - Полное руководство по интеграции

## Новые функции и возможности

### 🚀 Интеграция с Backend API
- **Полная интеграция**: Angular frontend интегрирован с Spring Boot backend API
- **Environment конфигурация**: Раздельные настройки для development и production
- **HTTP сервисы**: Обновленные API сервисы с правильной обработкой ошибок
- **WebSocket поддержка**: Real-time уведомления и обновления

### 📊 Нагрузочное тестирование
- **Apache JMeter тесты**: Готовые сценарии нагрузочного тестирования
- **Множественные сценарии**: Light, Medium, Heavy, Stress тестирование
- **Автоматизированные отчеты**: Детальные отчеты о производительности
- **Мониторинг ресурсов**: Отслеживание CPU, памяти и диска

### 🧪 E2E тестирование
- **Полный workflow**: Тестирование всего жизненного цикла управления проектами
- **Cypress тесты**: Автоматизированные E2E тесты для всех функций
- **Коллаборация**: Тестирование командной работы и real-time функций
- **Аналитика**: Тестирование отчетов и аналитических функций

### 📚 Обновленная документация
- **API документация**: Полная документация всех endpoints
- **Пользовательские руководства**: Подробные инструкции по использованию
- **Техническая документация**: Архитектура и настройка системы
