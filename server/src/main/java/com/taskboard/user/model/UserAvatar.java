...
/**
 * Entity для хранения метаданных аватаров пользователей. Сами файлы хранятся в S3/MinIO, здесь
 * только метаданные.
 */
@Entity
...
@SQLDelete(
    sql = "UPDATE user_avatars SET deleted_at = CURRENT_TIMESTAMP, is_active = false WHERE id = ?")
...
public class UserAvatar {
  ...
  public UserAvatar(
      Long userId, String storageKey, String contentType, Long fileSize, String originalFilename) {
    this.userId = userId;
