...
public interface UserRepository extends JpaRepository<UserEntity, Long> {
  ...
  @Modifying
  @Query(
      "UPDATE UserEntity u SET u.passwordResetToken = null, u.passwordResetTokenExpiry = null "
   ...
   */
  List<UserEntity> findByEmailContainingIgnoreCaseOrUsernameContainingIgnoreCase(
