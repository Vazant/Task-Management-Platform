 ...
 * Provides REST API endpoints for passwordless authentication
 */
@RestController
...
public class WebAuthnController {
    ...
    public ResponseEntity<Map<String, Object>> verifyRegistration(
        ...
        try {
            ...
            boolean success = webAuthnService.validateAndSaveCredential(challenge, credentialResponse, userId);
            ...
            if (success) {
                ...
                return ResponseEntity.badRequest().body(createErrorResponse("Не удалось зарегистрировать Passkey"));
            }
    ...
    public ResponseEntity<String> createAuthenticationChallenge(
    ...
    public ResponseEntity<Map<String, Object>> verifyAuthentication(
        ...
        try {
            boolean success = webAuthnService.validateAuthentication(challenge, credentialResponse, userId);
    ...
    public ResponseEntity<List<WebAuthnCredential>> getUserCredentials(Authentication authentication) {
        try {
            String userId = getUserIdFromAuthentication(authentication);
