...
/**
 * Service for working with DPoP (Demonstrating Proof of Possession) tokens Provides additional
 * security for OAuth 2.0 tokens by binding them to client keys
 *
 * <p>DPoP ensures that only the client that requested an access token can use it, preventing token
...
public class DpopTokenService {
  ...
  public String createDpopProof(
      String accessToken, String httpMethod, String httpUrl, String nonce) {
    try {
   ...
   */
  public boolean validateDpopProof(
      String dpopProof, String accessToken, String httpMethod, String httpUrl, String nonce) {
    try {
  ...
  private boolean validateRequiredClaims(
      Claims claims, String httpMethod, String httpUrl, String nonce) {
