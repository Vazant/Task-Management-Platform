...
public class MessageService {
  ...
  public String getMessage(final String key, final Object[] args) {
    log.debug("DEBUG 2-param-array: key={}, args={}", key, java.util.Arrays.toString(args));
    String message = messageSource.getMessage(key, null, LocaleContextHolder.getLocale());
    log.debug("DEBUG 2-param-array: message={}", message);
    String result = MessageFormat.format(message, args);
    log.debug("DEBUG 2-param-array: result={}", result);
    return result;
  }
  ...
  public String getMessageWithDefault(
      final String key, final Locale locale, final String defaultMessage) {
    System.out.println(
        "DEBUG 3-param-default-locale: key="
            + key
            + ", locale="
            + locale
            + ", defaultMessage="
   ...
   */
  public String getMessageWithDefault(
      final String key, final String defaultMessage, final Locale locale) {
    System.out.println(
        "DEBUG 3-param-default: key="
            + key
            + ", defaultMessage="
            + defaultMessage
            + ", locale="
  ...
  public String getMessage(
      final String key, final Object[] args, final String defaultMessage, final Locale locale) {
