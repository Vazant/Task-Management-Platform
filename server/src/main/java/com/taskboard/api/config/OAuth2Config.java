...
/**
 * OAuth2 configuration with PKCE support for confidential clients
 * Implements Spring Security 6.5 OAuth2 features including PKCE for all client types
 */
@Configuration
public class OAuth2Config {
    ...
    /**
     * Custom OAuth2 client with PKCE enabled for confidential clients
     * Demonstrates the new Spring Security 6.5 feature
     */
