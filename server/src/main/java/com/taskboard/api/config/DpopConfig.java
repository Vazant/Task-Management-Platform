...
/**
 * Configuration for DPoP (Demonstrating Proof of Possession) tokens Provides additional security
 * for OAuth 2.0 tokens by binding them to client keys
 *
...
public class DpopConfig {
  ...
  /**
   * JWT decoder configuration for DPoP tokens In production, use RSA keys or JWK Set for better
   * security
   *
  ...
  /**
   * Converter for extracting authorities from JWT token Maps JWT claims to Spring Security
   * authorities
   *
