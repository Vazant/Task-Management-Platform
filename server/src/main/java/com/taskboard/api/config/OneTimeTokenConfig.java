...
/**
 * Configuration for One-Time Token Login using Spring Security 6.5 DSL Provides secure temporary
 * access without requiring passwords
 */
@Configuration
public class OneTimeTokenConfig {
  ...
  /**
   * Custom handler for One-Time Token generation success This handles the delivery of tokens
   * (email, SMS, etc.)
   */
  @Bean
  ...
  /** Custom handler for One-Time Token generation success Handles token delivery to users */
  public static class OneTimeTokenGenerationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(
      ...
      System.out.println(
          "One-Time Token generated successfully for user: " + authentication.getName());
    }
  }
}
