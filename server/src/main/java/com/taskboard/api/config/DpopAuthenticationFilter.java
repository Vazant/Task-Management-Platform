...
/**
 * Filter for processing DPoP (Demonstrating Proof of Possession) tokens Validates DPoP proof tokens
 * and ensures they match the access token
 */
@Component
@Slf4j
public class DpopAuthenticationFilter extends OncePerRequestFilter {

  @Autowired private DpopTokenService dpopTokenService;
