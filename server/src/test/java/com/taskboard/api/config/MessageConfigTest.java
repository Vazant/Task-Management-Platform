...
public class MessageConfigTest {
  ...
  public void testLocaleResolverBean() {
    ...
    assertTrue(
        localeResolver instanceof org.springframework.web.servlet.i18n.AcceptHeaderLocaleResolver,
  ...
  public void testSupportedLocales() {
    ...
    assertDoesNotThrow(
        () -> {
          String messageRu =
              messageSource.getMessage("auth.login.success", null, Locale.forLanguageTag("ru"));
  ...
  public void testValidationMessageSource() {
    ...
    String validationMessage =
        messageSource.getMessage("validation.email.required", null, Locale.ENGLISH);
    assertEquals("Email is required", validationMessage);

    String validationMessageRu =
        messageSource.getMessage("validation.email.required", null, Locale.forLanguageTag("ru"));
