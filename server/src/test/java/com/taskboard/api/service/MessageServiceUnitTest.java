...
public class MessageServiceUnitTest {
    ...
    public void testGetMessageWithDefaultMessage() {
        ...
        String message = messageService.getMessage("nonexistent.key", new Object[]{}, "Default message", Locale.ENGLISH);
    ...
    public void testSpringPluralization() {
        ...
        String message1 = messageService.getMessage("cart.items.count", new Object[]{1}, Locale.ENGLISH);
        assertEquals("1 item", message1);

        String message2 = messageService.getMessage("cart.items.count", new Object[]{2}, Locale.ENGLISH);
        assertEquals("2 items", message2);

        String messageRu1 = messageService.getMessage("cart.items.count", new Object[]{1}, Locale.forLanguageTag("ru"));
        assertEquals("1 товар", messageRu1);

        String messageRu2 = messageService.getMessage("cart.items.count", new Object[]{2}, Locale.forLanguageTag("ru"));
        assertEquals("2 товара", messageRu2);

        String messageRu5 = messageService.getMessage("cart.items.count", new Object[]{5}, Locale.forLanguageTag("ru"));
