...
/**
 * Unit tests for DPoP Token Service
 * Tests DPoP proof token creation and validation functionality
 */
...
class DpopTokenServiceTest {
    ...
    void testValidateDpopProofSuccess() {
        ...
        // When
        boolean isValid = dpopTokenService.validateDpopProof(dpopProof, accessToken, httpMethod, httpUrl, nonce);
    ...
    void testValidateDpopProofWithWrongAccessToken() {
        ...
        // When
        boolean isValid = dpopTokenService.validateDpopProof(dpopProof, wrongAccessToken, httpMethod, httpUrl, nonce);
    ...
    void testValidateDpopProofWithWrongHttpMethod() {
        ...
        // When
        boolean isValid = dpopTokenService.validateDpopProof(dpopProof, accessToken, wrongHttpMethod, httpUrl, nonce);
    ...
    void testValidateDpopProofWithWrongHttpUrl() {
        ...
        // When
        boolean isValid = dpopTokenService.validateDpopProof(dpopProof, accessToken, httpMethod, wrongHttpUrl, nonce);
    ...
    void testValidateDpopProofWithWrongNonce() {
        ...
        // When
        boolean isValid = dpopTokenService.validateDpopProof(dpopProof, accessToken, httpMethod, httpUrl, wrongNonce);
    ...
    void testValidateDpopProofWithInvalidToken() {
        ...
        // When
        boolean isValid = dpopTokenService.validateDpopProof(invalidDpopProof, accessToken, httpMethod, httpUrl, nonce);
