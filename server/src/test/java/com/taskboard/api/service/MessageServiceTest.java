...
public class MessageServiceTest {
  ...
  public void testGetMessageWithDefaultMessage() {
    ...
    String message =
        messageService.getMessage("nonexistent.key", "Default message", Locale.ENGLISH);
  ...
  public void testICUPluralization() {
    ...
    String messageRu1 =
        messageService.getMessage("cart.items.count", 1, Locale.forLanguageTag("ru"));
    assertEquals("1 товар", messageRu1);

    String messageRu2 =
        messageService.getMessage("cart.items.count", 2, Locale.forLanguageTag("ru"));
    assertEquals("2 товара", messageRu2);

    String messageRu5 =
        messageService.getMessage("cart.items.count", 5, Locale.forLanguageTag("ru"));
